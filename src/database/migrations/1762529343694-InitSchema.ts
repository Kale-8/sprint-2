...
export class InitSchema1762529343694 implements MigrationInterface {//Aca definimos la clase de la migracion osea las queries para crear o eliminar tablas.
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "usuario" ("id" SERIAL NOT NULL, "nombre" VARCHAR NOT NULL, "email" VARCHAR NOT NULL, "password" VARCHAR NOT NULL, "role" VARCHAR, CONSTRAINT "PK_usuario_id" PRIMARY KEY ("id"), CONSTRAINT "UQ_usuario_email" UNIQUE ("email"))`);
        
    }

    public async down(queryRunner: QueryRunner): Promise<void> {//Aca definimos las queries para eliminar las tablas creadas en el metodo up.
