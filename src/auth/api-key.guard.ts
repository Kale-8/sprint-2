...
@Injectable()
export class ApiKeyGuard implements CanActivate { //CanActivate decide si la petición puede continuar o no.
  canActivate(context: ExecutionContext): boolean {   //CanActivate se ejecuta antes del controlador y con el context accede a la peticion.
