...
export class GoogleStrategy extends PassportStrategy(Strategy, 'google') {
  //estrategia Passport usando la estrategia de Google, con el nombre 'google'. Ese nombre es el que usarás en AuthGuard('google').
  constructor() {
    super({
      //Inicializamos la estrategia con las credenciales de Google
