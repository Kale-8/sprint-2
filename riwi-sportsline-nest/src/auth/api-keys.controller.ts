...
export class ApiKeysController {
    ...
    @ApiResponse({ status: 201, description: 'API key creada exitosamente. La key en texto plano solo se muestra una vez.' })
    ...
    @ApiResponse({ status: 200, description: 'Lista de API keys (sin mostrar keys completas)' })
    findAll() {
